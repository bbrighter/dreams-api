...
func TestGetStatistics(t *testing.T) {
	...
	tests := []apiTest{
		{name: "get empty statistics", method: http.MethodGet, url: "/statistics", statusCode: http.StatusOK,
		...
		{name: "get filled statistics", method: http.MethodGet, url: "/statistics", statusCode: http.StatusOK,
			response: entity.CountsResponse{
				Categories: []entity.CountResponse{{ID: 1, Count: 1}},
